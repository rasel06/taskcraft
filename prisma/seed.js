...
async function main() {
  ...
  const adminRole = await prisma.workspaceRole.create({
    data: {
      name: "Admin",
      isSystem: true,
      permissions: "manage_members,manage_roles,manage_teams,manage_project_statuses,manage_issue_statuses,delete_issues,view_all_teams,view_all_projects,view_audit_log",
    },
  });
